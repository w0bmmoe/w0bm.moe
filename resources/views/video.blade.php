    ...
    <div class="vertical-align">
        <div class="wrapper">
            <div class="embed-responsive embed-responsive-16by9">
                <video id="video" loop autoplay controls preload="auto" src="@if(env('APP_DEBUG')){{"/b"}}@else{{"//b.w0bm.moe"}}@endif{{ "/" . $video->file }}"></video>
            </div>
