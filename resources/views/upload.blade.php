...
<div class="form-group">
        <div id="dragndrop" class="form-group col-md-3" data-uploadlimit="{{ isset($user) ? ($user->can('break_max_filesize') ? 'false' : 'true') : 'true' }}">
		    ...
		    <p style="text-align:center; padding-top: 5px; white-space: normal;"><span id="big">100</span> uploads <span id="big">every 12 hours.</span> – Maximum filesize: <span id="big">100MB.</span> – Only <span id="big">.webm</span> allowed. Need <a href="/webm">help?</a></p>
